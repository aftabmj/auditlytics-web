    ...
    <div class="relative max-w-6xl mx-auto px-2 sm:px-6">
      <div class="pt-32 md:pt-28">
        ...
        <div class="grid grid-cols-2 gap-4 my-10">
          <div >
            <ul class="list-none space-y-4" data-aos="fade-up" data-aos-delay="100">
              <li class="flex items-center">
                    ...
                    <span>
                    Comprehensive risk management, internal audit, and assurance services.
                  </span>
                    </li>
                    <li class="flex items-center">
                      <svg class="w-3 h-3 fill-current text-indigo-400 mr-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span>Customised & practical solutions in various aspects of data analytics, risk management, assurance and
                      internal audit.</span></li>
                  </ul>

          </div>
          <div
            class="max-w-xs  mx-auto sm:max-w-none sm:inline-flex sm:justify-center flex items-center"
          ...
          <!-- <p class="text-xl text-slate-500 mb-10" data-aos="fade-up" data-aos-delay="100"> -->
